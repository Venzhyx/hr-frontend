          ...
          <Section title="Informasi Pengaju">
            <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-2xl">
              <div className="w-12 h-12 rounded-xl overflow-hidden flex-shrink-0 ring-2 ring-white shadow-sm">
                {empPhoto ? (
                  <img src={empPhoto} alt={overtime.employeeName} className="w-full h-full object-cover" />
                ) : (
...
const AdminOvertime = () => {
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Overtime (Admin)</h1>
