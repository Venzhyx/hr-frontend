...
export default function IndexAccount() {
  ...
  const { list, loading, error, fetchUsers, deleteUser, toggleUserActive, actionLoading } = useUser();
              ...
              <table className="w-full border-collapse text-left">
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-100">
                    {["ID", "Username", "Role", "Employee", "Status", "Dibuat", ""].map(
                      (h) => (
                        <th
                          key={h}
                          className="px-5 py-3 text-[10px] font-bold uppercase tracking-wider text-gray-400 whitespace-nowrap"
                        >
                          {h}
                        </th>
                      )
                        ...
                        <td className="px-5 py-3.5">
                          <div className="flex gap-2 justify-end">
                            ...
                            <button
                              ...
                              title="Hapus"
                              disabled={actionLoading}
                              className="p-2 bg-red-50 text-red-600 hover:bg-red-100 hover:text-red-700 rounded-xl transition-all"
                            >
